(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const ae={low:{id:"low",renderScale:.58,maxPixelRatio:1,starLayers:1,bloom:.25,targetFps:60},balanced:{id:"balanced",renderScale:.82,maxPixelRatio:1.5,starLayers:2,bloom:.45,targetFps:60},high:{id:"high",renderScale:1,maxPixelRatio:2,starLayers:3,bloom:.72,targetFps:90},ultra:{id:"ultra",renderScale:1.18,maxPixelRatio:2.5,starLayers:4,bloom:.95,targetFps:120}},we=[{id:"apod",name:"Astronomy Picture of the Day",agency:"NASA",module:"orbit",status:"live",browserPolicy:"keyed-cors",description:"Daily astronomy media and an expert-written explanation.",docs:"https://api.nasa.gov/"},{id:"neows",name:"Asteroids NeoWs",agency:"NASA/JPL",module:"neo",status:"live",browserPolicy:"keyed-cors",description:"Near-Earth object discovery, close-approach, velocity, size, and hazard metadata.",docs:"https://api.nasa.gov/"},{id:"donki",name:"DONKI Space Weather",agency:"NASA/GSFC",module:"helio",status:"live",browserPolicy:"keyed-cors",description:"Coronal mass ejections, solar flares, and linked space-weather analyses.",docs:"https://api.nasa.gov/"},{id:"epic",name:"DSCOVR EPIC",agency:"NASA/NOAA",module:"earth",status:"live",browserPolicy:"keyed-cors",description:"Full-disc Earth imagery and observation geometry from the L1 point.",docs:"https://epic.gsfc.nasa.gov/about/api"},{id:"eonet",name:"EONET v3",agency:"NASA/GSFC",module:"earth",status:"live",browserPolicy:"cors",description:"Curated natural-event metadata with categories, sources, time, and GeoJSON geometry.",docs:"https://eonet.gsfc.nasa.gov/docs/v3"},{id:"images",name:"NASA Image and Video Library",agency:"NASA",module:"archive",status:"live",browserPolicy:"cors",description:"Searchable image, video, and audio records with source metadata and asset manifests.",docs:"https://images.nasa.gov/docs/images.nasa.gov_api_docs.pdf"},{id:"gibs",name:"Global Imagery Browse Services",agency:"NASA EOSDIS",module:"earth",status:"live",browserPolicy:"cors",description:"Standards-based global satellite imagery layers for Earth science.",docs:"https://nasa-gibs.github.io/gibs-api-docs/"},{id:"exoplanet",name:"NASA Exoplanet Archive TAP",agency:"NASA/IPAC",module:"catalog",status:"live",browserPolicy:"deep-link-only",description:"Confirmed planets, host stars, candidates, and derived planetary-system parameters.",docs:"https://exoplanetarchive.ipac.caltech.edu/docs/TAP/usingTAP.html"},{id:"techtransfer",name:"NASA Technology Transfer",agency:"NASA",module:"catalog",status:"live",browserPolicy:"keyed-cors",description:"Patents, software, and technologies available for licensing.",docs:"https://api.nasa.gov/"},{id:"tle",name:"NASA Two-Line Elements",agency:"NASA",module:"orbit",status:"live",browserPolicy:"keyed-cors",description:"Orbital element sets for tracked spacecraft and objects.",docs:"https://api.nasa.gov/"},{id:"jpl-ssd",name:"JPL SSD/CNEOS API Service",agency:"NASA/JPL",module:"catalog",status:"reference-only",browserPolicy:"deep-link-only",description:"Horizons, SBDB, Sentry, Scout, fireballs, close approaches, and other specialist services. Official policy prohibits embedding these endpoints in a website.",docs:"https://ssd-api.jpl.nasa.gov/"},{id:"mars-rover",name:"Mars Rover Photos",agency:"NASA/JPL",module:"archive",status:"archived",browserPolicy:"deep-link-only",description:"Legacy Mars rover photo endpoint; the NASA API portal marks it archived.",docs:"https://api.nasa.gov/"},{id:"insight",name:"InSight Mars Weather",agency:"NASA/JPL",module:"archive",status:"archived",browserPolicy:"deep-link-only",description:"Historical weather observations from the completed InSight mission.",docs:"https://api.nasa.gov/"}],Ee={orbit:[.15,.78,1],earth:[.1,.88,.72],neo:[1,.42,.16],helio:[1,.16,.42],archive:[.67,.36,1]},R="https://api.nasa.gov",xe="https://eonet.gsfc.nasa.gov/api/v3",De="https://images-api.nasa.gov",oe="opus5-api-v1:",Pe=14e3;function g(a){return typeof a=="object"&&a!==null&&!Array.isArray(a)}function u(a,e=""){return typeof a=="string"?a:e}function E(a,e=0){const t=typeof a=="number"?a:Number(a);return Number.isFinite(t)?t:e}function A(a){return Array.isArray(a)?a:[]}function M(){return new Date().toISOString().slice(0,10)}function ke(a){return new Date(Date.now()-a*864e5).toISOString().slice(0,10)}function ie(){try{return typeof localStorage>"u"?null:localStorage}catch{return null}}class Ce{constructor(e=3){this.concurrency=e}concurrency;active=0;queue=[];async get(e,t,o,i=!1){const r=ie(),s=`${oe}${t}`,n=this.readCache(r,s);if(!i&&n&&Date.now()-n.storedAt<o)return{data:n.data,mode:"cache"};try{const l=await this.schedule(async()=>{const p=new AbortController,v=window.setTimeout(()=>p.abort(),Pe);try{const x=await fetch(e,{signal:p.signal,headers:{Accept:"application/json"},referrerPolicy:"strict-origin-when-cross-origin"});if(!x.ok)throw new Error(`HTTP ${x.status}`);return await x.json()}finally{window.clearTimeout(v)}});try{r?.setItem(s,JSON.stringify({storedAt:Date.now(),data:l}))}catch{}return{data:l,mode:"live"}}catch(l){if(n)return{data:n.data,mode:"cache"};throw l}}clear(){const e=ie();if(e)for(let t=e.length-1;t>=0;t-=1){const o=e.key(t);o?.startsWith(oe)&&e.removeItem(o)}}readCache(e,t){try{const o=e?.getItem(t);if(!o)return null;const i=JSON.parse(o);return!i||typeof i.storedAt!="number"||!("data"in i)?null:i}catch{return null}}schedule(e){return new Promise((t,o)=>{const i=()=>{this.active+=1,e().then(t,o).finally(()=>{this.active-=1,this.pump()})};this.queue.push(i),this.pump()})}pump(){for(;this.active<this.concurrency&&this.queue.length;)this.queue.shift()?.()}}function Ne(a){if(!g(a)||!u(a.title)||!u(a.date))throw new Error("Invalid APOD payload");const e=u(a.media_type);return{title:u(a.title),explanation:u(a.explanation,"No explanation supplied."),date:u(a.date),mediaType:e==="image"||e==="video"?e:"other",url:u(a.url),hdUrl:u(a.hdurl)||void 0,thumbnailUrl:u(a.thumbnail_url)||void 0,copyright:u(a.copyright)||void 0}}function Re(a){if(!g(a)||!g(a.near_earth_objects))throw new Error("Invalid NeoWs payload");return Object.values(a.near_earth_objects).flatMap(A).slice(0,36).map((t,o)=>{if(!g(t))throw new Error("Invalid NeoWs object");const i=g(t.estimated_diameter)&&g(t.estimated_diameter.kilometers)?t.estimated_diameter.kilometers:{},r=A(t.close_approach_data),s=g(r[0])?r[0]:{},n=g(s.relative_velocity)?s.relative_velocity:{},l=g(s.miss_distance)?s.miss_distance:{},p=E(i.estimated_diameter_min),v=E(i.estimated_diameter_max);return{id:u(t.id,`neo-${o}`),name:u(t.name,`Object ${o+1}`),diameterKm:(p+v)/2,velocityKps:E(n.kilometers_per_second),missDistanceKm:E(l.kilometers),hazardous:t.is_potentially_hazardous_asteroid===!0,nasaUrl:g(t.nasa_jpl_url)?"":u(t.nasa_jpl_url)}})}function Me(a){if(!g(a)||!Array.isArray(a.events))throw new Error("Invalid EONET payload");return a.events.slice(0,24).flatMap((e,t)=>{if(!g(e))return[];const i=[...A(e.geometry)].reverse().find(v=>g(v)&&g(v.geometry));if(!g(i)||!g(i.geometry))return[];const r=A(i.geometry.coordinates);if(u(i.geometry.type)!=="Point"||r.length<2)return[];const s=A(e.categories),n=g(s[0])?u(s[0].title,"Event"):"Event",l=A(e.sources),p=g(l[0])?u(l[0].url):"";return[{id:u(e.id,`event-${t}`),title:u(e.title,"Earth event"),category:n,longitude:E(r[0]),latitude:E(r[1]),date:u(i.date),sourceUrl:p||void 0}]})}function Te(a,e){const t=[];for(const[o,i]of A(a).entries()){if(!g(i))continue;const r=A(i.cmeAnalyses),s=g(r[0])?r[0]:{};t.push({id:u(i.activityID,`cme-${o}`),type:"CME",startTime:u(i.startTime),speedKps:E(s.speed)||void 0,sourceUrl:u(i.link)||void 0})}for(const[o,i]of A(e).entries())g(i)&&t.push({id:u(i.flrID,`flare-${o}`),type:"FLR",startTime:u(i.beginTime),classType:u(i.classType)||void 0,sourceUrl:u(i.link)||void 0});return t.sort((o,i)=>i.startTime.localeCompare(o.startTime)).slice(0,30)}function Oe(a,e){return A(a).slice(0,12).flatMap(t=>{if(!g(t)||!u(t.image)||!u(t.date))return[];const o=u(t.date),i=o.slice(0,10).replaceAll("-","/"),r=g(t.centroid_coordinates)?t.centroid_coordinates:{};return[{identifier:u(t.identifier,u(t.image)),caption:u(t.caption,"DSCOVR EPIC Earth observation"),date:o,imageUrl:`${R}/EPIC/archive/natural/${i}/png/${encodeURIComponent(u(t.image))}.png?api_key=${encodeURIComponent(e)}`,centroid:{lat:E(r.lat),lon:E(r.lon)}}]})}function Le(a){if(!g(a)||!g(a.collection)||!Array.isArray(a.collection.items))throw new Error("Invalid NASA Images payload");return a.collection.items.slice(0,24).flatMap(e=>{if(!g(e))return[];const t=A(e.data),o=g(t[0])?t[0]:{},r=A(e.links).find(s=>g(s)&&u(s.rel)==="preview");return!g(r)||!u(r.href)?[]:[{nasaId:u(o.nasa_id),title:u(o.title,"Untitled NASA asset"),description:u(o.description_508,u(o.description)).slice(0,600),date:u(o.date_created),center:u(o.center,"NASA"),previewUrl:u(r.href),mediaType:u(o.media_type,"image")}]})}function y(a,e,t,o){return{data:a,mode:e,source:t,fetchedAt:new Date().toISOString(),sourceTimestamp:o}}const _={apod:{title:"Live astronomy signal pending",explanation:"A deterministic demonstration scene is active while the live APOD endpoint is unavailable. No current NASA observation is being claimed.",date:M(),mediaType:"other",url:""},neo:Array.from({length:14},(a,e)=>({id:`demo-${e}`,name:`Demonstration object ${String.fromCharCode(65+e)}`,diameterKm:.08+e*37%80/100,velocityKps:8+e*19%31,missDistanceKm:9e5+e*54e4,hazardous:e%6===0,nasaUrl:""})),earth:[{id:"demo-wildfire",title:"Demonstration wildfire signal",category:"Wildfires",longitude:-54.5,latitude:-12.2,date:M()},{id:"demo-storm",title:"Demonstration storm signal",category:"Severe Storms",longitude:139.2,latitude:24.5,date:M()},{id:"demo-volcano",title:"Demonstration volcano signal",category:"Volcanoes",longitude:110.4,latitude:-7.5,date:M()}],solar:[{id:"demo-flare",type:"FLR",startTime:new Date().toISOString(),classType:"DEMO"},{id:"demo-cme",type:"CME",startTime:new Date(Date.now()-72e5).toISOString(),speedKps:520}]};class _e extends EventTarget{broker=new Ce(3);apiKey=sessionStorage.getItem("opus5-nasa-key")||"DEMO_KEY";statuses=new Map;get keyIsDemo(){return this.apiKey==="DEMO_KEY"}setApiKey(e){const t=e.trim()||"DEMO_KEY";this.apiKey=t,t==="DEMO_KEY"?sessionStorage.removeItem("opus5-nasa-key"):sessionStorage.setItem("opus5-nasa-key",t),this.broker.clear()}getStatuses(){return[...this.statuses.values()]}async loadApod(e=!1){return this.guard("apod",async()=>{const t=await this.broker.get(`${R}/planetary/apod?api_key=${encodeURIComponent(this.apiKey)}&thumbs=true`,"apod",36e5,e),o=Ne(t.data);return y(o,t.mode,"NASA APOD",o.date)},()=>y(_.apod,"demo","Built-in demonstration"))}async loadNeo(e=!1){return this.guard("neows",async()=>{const t=M(),o=`${R}/neo/rest/v1/feed?start_date=${t}&end_date=${t}&api_key=${encodeURIComponent(this.apiKey)}`,i=await this.broker.get(o,`neo-${t}`,18e5,e);return y(Re(i.data),i.mode,"NASA/JPL NeoWs",t)},()=>y(_.neo,"demo","Built-in demonstration"))}async loadEarth(e=!1){const[t,o]=await Promise.all([this.guard("eonet",async()=>{const i=await this.broker.get(`${xe}/events?status=open&limit=24&days=60`,"eonet-open",18e5,e);return y(Me(i.data),i.mode,"NASA EONET v3")},()=>y(_.earth,"demo","Built-in demonstration")),this.guard("epic",async()=>{const i=await this.broker.get(`${R}/EPIC/api/natural?api_key=${encodeURIComponent(this.apiKey)}`,"epic-natural",36e5,e),r=Oe(i.data,this.apiKey);if(!r.length)throw new Error("EPIC returned no frames");return y(r,i.mode,"NASA DSCOVR EPIC",r[0]?.date)},()=>y([],"demo","Built-in demonstration"))]);return{events:t,epic:o}}async loadSolar(e=!1){return this.guard("donki",async()=>{const t=ke(30),o=M(),i=`${R}/DONKI/CME?startDate=${t}&endDate=${o}&api_key=${encodeURIComponent(this.apiKey)}`,r=`${R}/DONKI/FLR?startDate=${t}&endDate=${o}&api_key=${encodeURIComponent(this.apiKey)}`,s=await this.broker.get(i,`donki-cme-${o}`,18e5,e),n=await this.broker.get(r,`donki-flr-${o}`,18e5,e),l=s.mode==="live"||n.mode==="live"?"live":"cache";return y(Te(s.data,n.data),l,"NASA DONKI",`${t} / ${o}`)},()=>y(_.solar,"demo","Built-in demonstration"))}async searchArchive(e,t=!1){const o=e.trim().slice(0,120)||"James Webb Space Telescope";return this.guard("images",async()=>{const i=`${De}/search?q=${encodeURIComponent(o)}&media_type=image&page_size=24`,r=await this.broker.get(i,`images-${o.toLowerCase()}`,864e5,t);return y(Le(r.data),r.mode,"NASA Image and Video Library")},()=>y([],"demo","Built-in demonstration"))}async guard(e,t,o){this.setStatus(e,"loading");try{const i=await t();return this.setStatus(e,i.mode),i}catch(i){const r=i instanceof Error?i.message:"Unknown error";return this.setStatus(e,"demo",r),o()}}setStatus(e,t,o){const i={id:e,status:t,message:o,updatedAt:new Date().toISOString()};this.statuses.set(e,i),this.dispatchEvent(new CustomEvent("status",{detail:i}))}}const W={orbit:[55,82.5],earth:[64,96],neo:[48,144],helio:[72,216],archive:[44,132]};class Ie{context=null;master=null;filter=null;oscillators=[];recordingDestination=null;enabled=!1;scene="orbit";energy=.3;get isEnabled(){return this.enabled}async setEnabled(e){e?(await this.ensureGraph(),await this.context?.resume(),this.enabled=!0,this.master?.gain.setTargetAtTime(.13,this.context?.currentTime??0,.22)):(this.enabled=!1,this.master?.gain.setTargetAtTime(1e-4,this.context?.currentTime??0,.16))}setScene(e){this.scene=e,this.retune()}setEnergy(e){this.energy=Math.max(0,Math.min(1,e)),!(!this.context||!this.filter)&&(this.filter.frequency.setTargetAtTime(280+this.energy*1250,this.context.currentTime,.35),this.filter.Q.setTargetAtTime(.6+this.energy*3.4,this.context.currentTime,.4))}pulse(e=.5){if(!this.enabled||!this.context||!this.master)return;const t=this.context.currentTime,o=this.context.createOscillator(),i=this.context.createGain();o.type="sine",o.frequency.setValueAtTime(W[this.scene][1]*(1+e),t),o.frequency.exponentialRampToValueAtTime(W[this.scene][0],t+.55),i.gain.setValueAtTime(1e-4,t),i.gain.exponentialRampToValueAtTime(.06,t+.018),i.gain.exponentialRampToValueAtTime(1e-4,t+.7),o.connect(i).connect(this.master),o.start(t),o.stop(t+.72)}getRecordingTrack(){return this.enabled?this.recordingDestination?.stream.getAudioTracks()[0]?.clone()??null:null}async ensureGraph(){if(this.context)return;this.context=new AudioContext({latencyHint:"interactive"}),this.master=this.context.createGain(),this.master.gain.value=1e-4,this.filter=this.context.createBiquadFilter(),this.filter.type="lowpass",this.filter.frequency.value=620,this.filter.Q.value=1.2,this.recordingDestination=this.context.createMediaStreamDestination(),this.filter.connect(this.master),this.master.connect(this.context.destination),this.master.connect(this.recordingDestination);const e=["sine","triangle","sine"],t=[-9,0,7];for(let p=0;p<3;p+=1){const v=this.context.createOscillator(),x=this.context.createGain();v.type=e[p]??"sine",v.detune.value=t[p]??0,x.gain.value=p===0?.58:.18,v.connect(x).connect(this.filter),v.start(),this.oscillators.push(v)}const o=this.context.sampleRate*3,i=this.context.createBuffer(1,o,this.context.sampleRate),r=i.getChannelData(0);let s=0;for(let p=0;p<r.length;p+=1){const v=Math.random()*2-1;s=s*.985+v*.015,r[p]=s*.16}const n=this.context.createBufferSource(),l=this.context.createGain();n.buffer=i,n.loop=!0,l.gain.value=.24,n.connect(l).connect(this.filter),n.start(),this.retune(),this.setEnergy(this.energy)}retune(){if(!this.context)return;const[e,t]=W[this.scene],o=[e,t,e*2.01];this.oscillators.forEach((i,r)=>{i.frequency.setTargetAtTime(o[r]??e,this.context.currentTime,.8)})}}const ze=["video/mp4;codecs=avc1.42E01E","video/mp4","video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm"];function Ue(a){return ze.find(a)||""}function Ke(a){return a.normalize("NFKD").replace(/[^a-zA-Z0-9._-]+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"").slice(0,100)||"nasa-opus5"}function le(a,e){const t=URL.createObjectURL(a),o=document.createElement("a");o.href=t,o.download=e,o.rel="noopener",document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(t),1e4)}async function Fe(a,e,t){const o=`image/${e}`,i=await new Promise(r=>a.toBlob(r,o,t));if(!i)throw new Error(`The browser could not encode ${o}`);return i}function $e(a,e){const t=a*e,o=navigator.deviceMemory;return t>335e5||o&&o<=2&&t>9e6?!1:a>0&&e>0}class qe{constructor(e){this.renderer=e}renderer;async export(e,t){if(!$e(e.width,e.height))throw new Error("EXPORT_CAPABILITY");const o=await this.renderer.renderExport(e.width,e.height,t),i=await Fe(o,e.format,e.quality);return le(i,`${Ke(e.filename)}.${e.format==="jpeg"?"jpg":e.format}`),o.width=1,o.height=1,i}}class He extends EventTarget{recorder=null;chunks=[];startedAt=0;stopTimer=0;activeMime="";get isRecording(){return this.recorder?.state==="recording"}get elapsedSeconds(){return this.startedAt?(performance.now()-this.startedAt)/1e3:0}start(e,t,o=60,i=120){if(this.isRecording)throw new Error("Recording is already active");if(!("MediaRecorder"in window)||!e.captureStream)throw new Error("RECORDING_UNSUPPORTED");const r=e.captureStream(o),s=new MediaStream(r.getVideoTracks());t&&s.addTrack(t),this.activeMime=Ue(l=>MediaRecorder.isTypeSupported(l));const n={videoBitsPerSecond:Math.max(8e6,Math.min(36e6,e.width*e.height*o*.12))};return this.activeMime&&(n.mimeType=this.activeMime),this.chunks=[],this.recorder=new MediaRecorder(s,n),this.recorder.addEventListener("dataavailable",l=>{l.data.size&&this.chunks.push(l.data)}),this.recorder.addEventListener("error",l=>this.dispatchEvent(new CustomEvent("error",{detail:l}))),this.recorder.start(1e3),this.startedAt=performance.now(),this.stopTimer=window.setTimeout(()=>{this.isRecording&&this.dispatchEvent(new Event("limit"))},i*1e3),this.activeMime||this.recorder.mimeType||"video/webm"}stop(){return!this.recorder||this.recorder.state==="inactive"?Promise.reject(new Error("No recording is active")):(window.clearTimeout(this.stopTimer),new Promise((e,t)=>{const o=this.recorder;o.addEventListener("stop",()=>{const i=this.activeMime||o.mimeType||"video/webm",r=i.startsWith("video/mp4")?"mp4":"webm",s=new Blob(this.chunks,{type:i});o.stream.getTracks().forEach(n=>n.stop()),this.recorder=null,this.startedAt=0,this.chunks=[],s.size?e({blob:s,extension:r,mimeType:i}):t(new Error("The recording contains no data"))},{once:!0}),o.stop()}))}}const We=`#version 300 es
...
void main() {
  ...
  <dialog class="mission-dialog settings-dialog" id="settings-dialog">
    <form method="dialog" class="dialog-shell" id="settings-form">
      ...
      <label class="field"><span data-i18n="language">Language</span><select id="language-select">${rt}</select></label>
...
`;const d=a=>{const e=document.getElementById(a);if(!e)throw new Error(`Missing interface element: ${a}`);return e},st=d("visual-stage"),w=new _e,b=new Ie,T=new He;let h=null,G=null,P="orbit",ne=0,ce=0;try{h=new je(st),G=new qe(h)}catch(a){d("webgl-fallback").hidden=!1,S(a instanceof Error?a.message:"WebGL initialization failed","error")}function he(){document.querySelectorAll("[data-i18n]").forEach(e=>{const t=e.dataset.i18n;t&&t in O.en&&(e.textContent=m(t))}),document.querySelectorAll("[data-i18n-placeholder]").forEach(e=>{const t=e.dataset.i18nPlaceholder;t&&t in O.en&&(e.placeholder=m(t))});const a=d("language-select");a.value=j(),me(P),J()}function me(a){const e=d("scene-title"),t=d("scene-description"),o={orbit:["orbit","orbitDesc"],earth:["earth","earthDesc"],neo:["neo","neoDesc"],helio:["helio","helioDesc"],archive:["archive","archiveDesc"]};e.textContent=m(o[a][0]),t.textContent=m(o[a][1])}function ge(a){try{const e=new URL(a);return e.protocol==="https:"?e.href:null}catch{return null}}function c(a,e,t){const o=document.createElement(a);return e&&(o.className=e),t!==void 0&&(o.textContent=t),o}function k(a,e){const t=c("div","metric-card");return t.append(c("span","",a),c("strong","",e)),t}function L(a){a.mode,d("panel-mode").textContent=a.mode==="live"?m("liveNotice"):a.mode==="cache"?m("cache"):m("demo"),d("data-source").textContent=a.source.toUpperCase(),d("data-time").textContent=new Date(a.fetchedAt).toLocaleTimeString(j(),{hour:"2-digit",minute:"2-digit"});const e=d("global-status");e.textContent=a.mode==="live"?m("live"):a.mode==="cache"?m("cache"):m("demo"),document.body.dataset.dataMode=a.mode}function nt(a){L(a);const e=d("data-content");e.replaceChildren();const t=a.data,o=c("article","feature-card apod-card"),i=ge(t.thumbnailUrl||(t.mediaType==="image"?t.url:""));if(i){const s=c("img");s.src=i,s.alt=t.title,s.loading="eager",s.referrerPolicy="no-referrer",o.append(s)}const r=c("div","feature-copy");r.append(c("span","eyebrow",`APOD · ${t.date}`),c("h2","",t.title),c("p","",t.explanation)),o.append(r),e.append(o),a.mode==="demo"&&e.append(c("p","notice demo-notice",m("fallbackNotice"))),h?.setData(.38,.08,1),b.setEnergy(.38)}function ct(a,e){L(a.mode==="live"?a:e);const t=d("data-content");t.replaceChildren();const o=c("div","metric-grid");o.append(k(m("activeEvents"),String(a.data.length)),k("EPIC",String(e.data.length))),t.append(o);const i=e.data[0];if(i&&ge(i.imageUrl)){const s=c("figure","epic-frame"),n=c("img");n.src=i.imageUrl,n.alt=i.caption,n.loading="lazy",n.referrerPolicy="no-referrer",s.append(n,c("figcaption","",`DSCOVR EPIC · ${i.date.slice(0,16)} UTC`)),t.append(s)}const r=c("ol","signal-list");a.data.slice(0,6).forEach(s=>{const n=c("li");n.append(c("span","event-marker"),c("div")),n.lastElementChild.append(c("strong","",s.title),c("small","",`${s.category} · ${s.latitude.toFixed(1)}°, ${s.longitude.toFixed(1)}°`)),r.append(n)}),t.append(r),h?.setEarthEvents(a.data),h?.setData(Math.min(1,a.data.length/20),.18,a.data.length),b.setEnergy(Math.min(1,a.data.length/20))}function lt(a){L(a);const e=d("data-content");e.replaceChildren();const t=a.data.filter(n=>n.hazardous).length,o=Math.max(0,...a.data.map(n=>n.velocityKps)),i=c("div","metric-grid");i.append(k("Objects",String(a.data.length)),k(m("hazardous"),String(t)),k("MAX ΔV",`${o.toFixed(1)} km/s`)),e.append(i);const r=c("ol","neo-list");a.data.slice(0,8).forEach(n=>{const l=c("li",n.hazardous?"risk":""),p=c("div");p.append(c("strong","",n.name),c("small","",n.hazardous?m("hazardous"):"TRACKED"));const v=c("div","neo-metrics");v.append(c("span","",`${n.diameterKm.toFixed(2)} km`),c("span","",`${n.velocityKps.toFixed(1)} km/s`),c("span","",`${(n.missDistanceKm/1e6).toFixed(2)}M km`)),l.append(p,v),r.append(l)}),e.append(r);const s=a.data.length?t/a.data.length:0;h?.setData(Math.min(1,o/60),s,a.data.length),b.setEnergy(Math.min(1,o/60))}function dt(a){L(a);const e=d("data-content");e.replaceChildren();const t=a.data.filter(n=>n.type==="CME"),o=a.data.filter(n=>n.type==="FLR"),i=c("div","metric-grid");i.append(k("CME · 30D",String(t.length)),k("FLARE · 30D",String(o.length))),e.append(i);const r=c("ol","signal-list solar-list");a.data.slice(0,9).forEach(n=>{const l=c("li"),p=c("span",`solar-marker ${n.type.toLowerCase()}`),v=c("div");v.append(c("strong","",`${n.type} ${n.classType||(n.speedKps?`${n.speedKps.toFixed(0)} km/s`:"")}`.trim()),c("small","",new Date(n.startTime).toLocaleString(j()))),l.append(p,v),r.append(l)}),e.append(r);const s=Math.min(1,(o.length+t.length*1.4)/18);h?.setData(s,.1,a.data.length),b.setEnergy(s)}function ve(a){L(a);const e=d("data-content");e.replaceChildren();const t=c("button","archive-launch");t.type="button",t.dataset.dialog="archive-dialog",t.append(c("span","archive-symbol","▦"),c("strong","",m("archive")),c("small","",`${a.data.length} ${m("noResults").replace("No ","").replace(".","")}`)),t.addEventListener("click",()=>X("archive-dialog")),e.append(t);const o=c("div","mini-mosaic");a.data.slice(0,4).forEach(i=>{const r=c("img");r.src=i.previewUrl,r.alt=i.title,r.loading="lazy",r.referrerPolicy="no-referrer",o.append(r)}),e.append(o,c("p","notice","NASA media remains separate from the computational canvas, preserving attribution and export integrity.")),fe(a.data),h?.setData(.58,.05,a.data.length),b.setEnergy(.58)}function fe(a){const e=d("archive-grid");if(e.replaceChildren(),!a.length){e.append(c("p","",m("noResults")));return}a.forEach(t=>{const o=c("article","archive-item"),i=c("img");i.src=t.previewUrl,i.alt=t.title,i.loading="lazy",i.referrerPolicy="no-referrer";const r=c("div");r.append(c("span","eyebrow",`${t.center} · ${t.date.slice(0,4)}`),c("h3","",t.title),c("p","",t.description));const s=c("a","archive-link","NASA ID ↗");s.href=`https://images.nasa.gov/details/${encodeURIComponent(t.nasaId)}`,s.target="_blank",s.rel="noopener noreferrer",r.append(s),o.append(i,r),e.append(o)})}async function z(a,e=!1){P=a,me(a),d("data-content").replaceChildren(c("div","skeleton tall"),c("div","skeleton"));try{if(a==="orbit")nt(await w.loadApod(e));else if(a==="earth"){const t=await w.loadEarth(e);ct(t.events,t.epic)}else a==="neo"?lt(await w.loadNeo(e)):a==="helio"?dt(await w.loadSolar(e)):ve(await w.searchArchive(d("archive-query").value||"James Webb Space Telescope",e))}catch(t){S(t instanceof Error?t.message:m("unavailable"),"error")}}function Y(a){document.querySelectorAll("[data-scene]").forEach(o=>{const i=o.dataset.scene===a;o.classList.toggle("active",i),o.setAttribute("aria-pressed",String(i))});const e=document.querySelector(".scene-transition");e?.classList.remove("flash"),requestAnimationFrame(()=>e?.classList.add("flash")),h?.setScene(a),b.setScene(a),b.pulse(.35);const t=new URL(location.href);t.searchParams.set("scene",a),history.replaceState(null,"",t),z(a)}function J(){const a=d("source-grid");a.replaceChildren();const e=new Map(w.getStatuses().map(t=>[t.id,t]));we.forEach(t=>{const o=e.get(t.id)?.status,i=c("article","source-card"),r=c("header"),s=t.status==="archived"?m("archived"):t.status==="reference-only"||t.browserPolicy==="deep-link-only"?m("referenceOnly"):m("browserReady");r.append(c("span",`status-light ${o||t.status}`),c("strong","",t.name),c("small","",s));const n=c("p","",t.description),l=c("footer");l.append(c("span","",t.agency));const p=c("a","",`${m("openDocs")} ↗`);p.href=t.docs,p.target="_blank",p.rel="noopener noreferrer",l.append(p),i.append(r,n,l),a.append(i)})}function X(a){const e=d(a);e.open||e.showModal()}function S(a,e="info"){const t=d("toast-region"),o=c("div",`toast ${e}`,a);t.append(o),window.setTimeout(()=>o.remove(),5200)}function ut(){const a=d("journey-button"),e=!a.classList.contains("active");if(a.classList.toggle("active",e),a.setAttribute("aria-pressed",String(e)),window.clearInterval(ne),e){const t=["orbit","earth","neo","helio","archive"];ne=window.setInterval(()=>Y(t[(t.indexOf(P)+1)%t.length]),18e3)}}async function Q(){const a=d("record-button"),e=a.querySelector("[data-i18n]"),t=d("record-time");if(T.isRecording){try{const o=await T.stop();le(o.blob,`NASA-OPUS5-${P}-${new Date().toISOString().replaceAll(":","-").slice(0,19)}.${o.extension}`),S(`${o.extension.toUpperCase()} · ${(o.blob.size/1048576).toFixed(1)} MB`,"success")}catch(o){S(o instanceof Error?o.message:m("unavailable"),"error")}window.clearInterval(ce),a.classList.remove("recording"),t.hidden=!0,t.textContent="00:00",e&&(e.textContent=m("record"))}else{if(!h)return S("WebGL canvas is unavailable.","error");try{const o=T.start(h.canvas,b.getRecordingTrack(),60,120);a.classList.add("recording"),t.hidden=!1,e&&(e.textContent=m("stop")),o.startsWith("video/mp4")||S(m("recorderFallback")),ce=window.setInterval(()=>{const i=Math.floor(T.elapsedSeconds);t.textContent=`${String(Math.floor(i/60)).padStart(2,"0")}:${String(i%60).padStart(2,"0")}`},500)}catch(o){S(o instanceof Error?o.message:m("unavailable"),"error")}}}document.querySelectorAll("[data-scene]").forEach(a=>a.addEventListener("click",()=>Y(a.dataset.scene)));document.querySelectorAll("[data-dialog]").forEach(a=>a.addEventListener("click",()=>X(a.dataset.dialog)));document.querySelectorAll("[data-close]").forEach(a=>a.addEventListener("click",()=>d(a.dataset.close).close()));document.querySelectorAll("dialog").forEach(a=>a.addEventListener("click",e=>{e.target===a&&a.close()}));d("journey-button").addEventListener("click",ut);d("data-panel-toggle").addEventListener("click",a=>{const e=a.currentTarget,t=d("data-panel");matchMedia("(max-width: 760px)").matches?(t.classList.toggle("mobile-open"),e.setAttribute("aria-expanded",String(t.classList.contains("mobile-open")))):(t.classList.toggle("collapsed"),e.setAttribute("aria-expanded",String(!t.classList.contains("collapsed"))))});d("quality-select").addEventListener("change",a=>{const e=a.target.value;h?.setQuality(e),localStorage.setItem("opus5-quality",e);const t=new URL(location.href);t.searchParams.set("quality",e),history.replaceState(null,"",t)});d("orbit-toggle").addEventListener("click",a=>{const e=a.currentTarget,t=!e.classList.contains("active");e.classList.toggle("active",t),e.setAttribute("aria-pressed",String(t)),h?.setOrbit(t)});d("orbit-speed").addEventListener("input",a=>h?.setOrbitSpeed(Number(a.target.value)));d("orbit-tilt").addEventListener("input",a=>h?.setOrbitTilt(Number(a.target.value)));d("sound-toggle").addEventListener("click",async a=>{const e=a.currentTarget;await b.setEnabled(!b.isEnabled),e.classList.toggle("active",b.isEnabled),e.setAttribute("aria-pressed",String(b.isEnabled)),b.pulse(.2)});d("record-button").addEventListener("click",()=>{Q()});T.addEventListener("limit",()=>{S("Recording reached the 120-second memory-safe limit."),Q()});d("settings-form").addEventListener("submit",()=>{const a=d("language-select").value;ue(a),he();const e=d("api-key-input").value;e.trim()&&w.setApiKey(e);const t=d("reduced-motion").checked;h?.setReducedMotion(t),localStorage.setItem("opus5-reduced-motion",String(t)),z(P,!0)});d("refresh-data").addEventListener("click",()=>{z(P,!0)});d("archive-search").addEventListener("submit",async a=>{a.preventDefault();const e=d("archive-query").value;d("archive-grid").replaceChildren(c("div","skeleton tall"));const o=await w.searchArchive(e,!0);fe(o.data),P==="archive"&&ve(o)});d("export-form").addEventListener("submit",async a=>{if(a.preventDefault(),!G||!h)return S("Renderer unavailable","error");const e=new FormData(a.currentTarget),t=String(e.get("resolution")),o=String(e.get("format")),i=h.getStats(),r=t==="8k"?[7680,4320]:t==="4k"?[3840,2160]:[i.width,i.height],s=d("export-progress"),n=s.querySelector("span"),l=d("export-message");s.hidden=!1,n.style.width="0%",l.textContent=m("exporting");try{const p=await G.export({width:r[0],height:r[1],format:o,quality:o==="jpeg"?.94:1,filename:`NASA-OPUS5-${P}-${r[0]}x${r[1]}`},v=>{n.style.width=`${Math.round(v*100)}%`});l.textContent=`${o.toUpperCase()} · ${r[0]} × ${r[1]} · ${(p.size/1048576).toFixed(1)} MB`,S(l.textContent,"success")}catch(p){l.textContent=p instanceof Error&&p.message==="EXPORT_CAPABILITY"?m("capabilityWarning"):p instanceof Error?p.message:m("unavailable"),S(l.textContent,"error")}});h?.addEventListener("stats",a=>{const e=a.detail;d("fps-value").textContent=e.fps.toFixed(0),d("resolution-value").textContent=`${e.width}×${e.height}`,d("viewport-size").textContent=`${e.width} × ${e.height}`});w.addEventListener("status",()=>J());window.addEventListener("keydown",a=>{a.target?.matches("input, select, textarea")||(a.key.toLowerCase()==="o"?d("orbit-toggle").click():a.key.toLowerCase()==="e"?X("export-dialog"):a.key.toLowerCase()==="r"?Q():a.key===" "?(a.preventDefault(),h&&h.setPaused(!h.state.paused)):h&&a.key.startsWith("Arrow")&&(a.preventDefault(),a.key==="ArrowLeft"&&(h.state.yaw-=.08),a.key==="ArrowRight"&&(h.state.yaw+=.08),a.key==="ArrowUp"&&(h.state.pitch=Math.min(1.2,h.state.pitch+.06)),a.key==="ArrowDown"&&(h.state.pitch=Math.max(-1.2,h.state.pitch-.06))))});const be=new URLSearchParams(location.search),B=be.get("scene"),I=be.get("quality")||localStorage.getItem("opus5-quality");I&&["auto","low","balanced","high","ultra"].includes(I)&&(d("quality-select").value=I,h?.setQuality(I));const ye=localStorage.getItem("opus5-reduced-motion")==="true"||window.matchMedia("(prefers-reduced-motion: reduce)").matches;d("reduced-motion").checked=ye;h?.setReducedMotion(ye);he();J();B&&["orbit","earth","neo","helio","archive"].includes(B)?Y(B):z("orbit");const pt=window;!pt.__OPUS5_ARTIFACT__&&"serviceWorker"in navigator&&location.protocol==="https:"&&window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));
